...
function connecterbdd($titre,$description,$media) {
	...
	$pass='';
		...
		$stmt = $dbh->prepare("INSERT INTO astucemaison(titre, description, media) VALUES (:value1, :value2, :value3)");
	...
	<body class="formulaire">
		<form action="" method="post">
			<fieldset>
				...
				<p> Titre de mon astuce maison : <input type="text" name="titre" value=""/> </p> </br> 
